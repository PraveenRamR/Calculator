...
minus=Button(cal,padx=16,pady=16,bd=8, fg="black", font=("arial",20,"bold"),text="-",command=lambda:btnclick("-")).grid(row=2,column=3)
...
mul=Button(cal,padx=16,pady=16,bd=8, fg="black", font=("arial",20,"bold"),text="*",command=lambda:btnclick("*")).grid(row=3,column=3)
btn0=Button(cal,padx=16,pady=16,bd=8, fg="black", font=("arial",20,"bold"),text="0",command=lambda:btnclick(0)).grid(row=4,column=0)
btnC=Button(cal,padx=16,pady=16,bd=8, fg="black", font=("arial",20,"bold"),text="C",command=btnClearTextDisplay).grid(row=4,column=1)
div=Button(cal,padx=16,pady=16,bd=8, fg="black", font=("arial",20,"bold"),text="/",command=lambda:btnclick("/")).grid(row=4,column=2)
equals=Button(cal,padx=16,pady=16,bd=8, fg="black", font=("arial",20,"bold"),text="=",command=btnEqualsInput).grid(row=4,column=3)
